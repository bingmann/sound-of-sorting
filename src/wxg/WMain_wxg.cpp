// -*- C++ -*-
//
// generated by wxGlade 01d8bb798de7+ on Wed May 22 09:09:45 2013
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    sizer_5_staticbox = new wxStaticBox(splitter_0_pane_2, wxID_ANY, _("Input and Algorithm"));
    ...
    pivotRuleLabel = new wxStaticText(splitter_0_pane_2, wxID_ANY, _("Pivot Rule: "));
    const wxString *pivotRuleChoice_choices = NULL;
    pivotRuleChoice = new wxChoice(splitter_0_pane_2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, pivotRuleChoice_choices, 0);
...
void WMain_wxg::do_layout()
{
    ...
    sizer_4->Add(aboutButton, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 4);
    sizer_4->Add(recordButton, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 4);
    ...
    sizer_4->Add(grid_sizer_3, 1, wxEXPAND, 0);
    ...
    sizer_5->Add(grid_sizer_1, 0, wxEXPAND, 0);
    sizer_5->Add(algoList, 1, wxEXPAND, 0);
    ...
    sizer_5->Add(sizerQuickSortPivot, 0, wxEXPAND, 0);
    sizer_5->Add(infoTextctrl, 0, wxEXPAND, 0);
    sizer_2->Add(sizer_5, 1, wxALL|wxEXPAND, 4);
